(() => {
  ...
  const Intro = () => el('section', { id: 'intro' },
    el('div', { class: 'intro-content' },
      ...
      el('div', { class: 'freelance-badge' },
        el('span', { class: 'pulse-dot' }),
        el('span', {}, '✦ Available for Freelance & Contract Work')
      ),
      el('a', { class: 'btn', href: '#/about', onclick: e => { e.preventDefault(); navigate('home', 'about'); } }, 'More About Me'),
      el('ul', { class: 'intro-social' },
        ...resume.social.map(s =>
          el('li', {}, el('a', { href: s.url, target: '_blank', rel: 'noopener' }, s.label))
        ),
        el('li', {}, el('a', {
          class: 'btn-hire-inline',
          href: '#/contact',
          onclick: e => { e.preventDefault(); navigate('home', 'contact'); }
        }, 'Hire Me'))
      )
    )
  );
    ...
    const list = [
      {
        ...
        desc: 'Design and deploy full ROS 2 stacks for mobile robots and drones',
        icon: `<svg class="service-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><circle cx="6" cy="6" r="3"/><circle cx="18" cy="6" r="3"/><circle cx="18" cy="18" r="3"/><circle cx="6" cy="18" r="3"/><line x1="12" y1="12" x2="6" y2="6"/><line x1="12" y1="12" x2="18" y2="6"/><line x1="12" y1="12" x2="18" y2="18"/><line x1="12" y1="12" x2="6" y2="18"/></svg>`
      },
      {
        title: 'Edge AI Deployment',
        desc: 'Run YOLO, TFLite, and ONNX models on embedded hardware (Pi, STM32, ESP32)',
        icon: `<svg class="service-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="2"/><rect x="9" y="9" width="6" height="6"/><line x1="9" y1="1" x2="9" y2="4"/><line x1="15" y1="1" x2="15" y2="4"/><line x1="9" y1="20" x2="9" y2="23"/><line x1="15" y1="20" x2="15" y2="23"/><line x1="20" y1="9" x2="23" y2="9"/><line x1="20" y1="15" x2="23" y2="15"/><line x1="1" y1="9" x2="4" y2="9"/><line x1="1" y1="15" x2="4" y2="15"/></svg>`
      },
      {
        title: 'Computer Vision Pipelines',
        desc: 'Custom AI solutions for vision based navigation, perception, detection, reading, motion capture etc.',
      ...
      {
        title: 'Robot Prototyping',
        desc: 'End-to-end hardware bring-up, sensor calibration, and rapid iteration',
        icon: `<svg class="service-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>`
      }
    ];

    return el('section', { id: 'services', class: 'alt' },
      sectionIntro('Services', 'Services I Offer.', 'Tailored engineering solutions for intelligent autonomous systems.<br>Check out my past works in my <a href="#/gallery">gallery</a>!'),
      el('div', { class: 'services-grid' },
        ...list.map(s => el('div', { class: 'service-card anim-fade-up' },
          el('div', { class: 'service-icon-wrap', html: s.icon }),
          el('h3', {}, s.title),
          el('p', { html: s.desc })
        ))
      )
  ...
  const HomePage = () => el('main', { class: 'page' },
    Intro(), HomeLatest(), About(), Services(), Projects(), Contact(), Footer()
  );
